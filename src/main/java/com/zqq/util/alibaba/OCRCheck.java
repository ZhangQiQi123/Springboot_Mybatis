...
import com.zqq.util.alibaba.HttpUtils;
...
public class OCRCheck {
    ...
    public static void main(String[] args){
        ...
        String imgFile = "C:\\Users\\zhangqiqi\\Pictures\\Saved Pictures\\1.jpg";
        ...
        try {
            ...
            finputstream.close();
            imgBase64 = new String(Base64.getEncoder().encodeToString(content));
        } catch (IOException e) {
            e.printStackTrace();
            return;
        }
